...
c22r_list = ['C22r = 1E-7','C22r = 1.5E-6']
...
for data in data_list: # lê cada uma das pastas da lista data
    ...
    for tau in tau_list: #para cada valor de tau
        ...
        fig, axs = plt.subplots(4, 2, figsize=figsize_init, 
...
#%% PLOTS - MATPLOTLIB
                ...
                axs[3][indice].xaxis.set_major_locator(ticker.MaxNLocator(11))
                axs[3][indice].set_xlabel('t [Gyr]')     #variável do eixo x
